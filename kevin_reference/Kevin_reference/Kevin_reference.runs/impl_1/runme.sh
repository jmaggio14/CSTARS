...
HD_PWD='/home/jeffmaggio/cstars/jeffstuff/code/kevin_reference/Kevin_reference/Kevin_reference.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kmk_star_fsm.vdi -applog -m64 -messageDb vivado.pb -mode batch -source kmk_star_fsm.tcl -notrace
