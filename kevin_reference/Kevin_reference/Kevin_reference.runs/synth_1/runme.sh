...
HD_PWD='/home/jeffmaggio/cstars/jeffstuff/code/kevin_reference/Kevin_reference/Kevin_reference.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kmk_star_fsm.vds -m64 -mode batch -messageDb vivado.pb -notrace -source kmk_star_fsm.tcl
